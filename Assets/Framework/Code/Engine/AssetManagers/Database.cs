...
namespace Jape
{
    public class Database : AssetManager<Database>, ISerializationCallbackReceiver
    {
        [Space(8)]
        ...
        internal Resource root = new Resource("", "", Resource.Type.Folder, "");
        ...
        {
            #if UNITY_EDITOR
            UnityEditor.EditorApplication.quitting += Update;
            #endif
    ...
    public class Resource : ISearchFilterable
    {
        ...
        public string AssetPath => string.IsNullOrEmpty(path) ? name : path + "/" + name;
    ...
    public class DatabasePostprocessor : UnityEditor.AssetPostprocessor
    {
        private static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
        {
            if (Database.Instance == null) { return; }
            if (!Database.Instance.UpdateAutomatically) { return; }
            ...
            foreach(var file in files)
            {
                ...
                if (!path.Contains("Database.asset") && path.Contains("/resources/"))
                {
                    update = true;
                    break;
                }
            ...
            if (update)
            {
                ...
                Database.Instance.OnAfterDeserialize();
            }
        }
    }
