...
namespace Jape
{
	public class Game
    {
        ...
        public static Sprite DefaultSprite => Database.GetAsset<Texture>("SpriteDefault100").Load<Sprite>();
        public static SpriteShape DefaultSpriteShape => Database.GetAsset<SpriteShape>("Default").Load<SpriteShape>();
        public static Texture DefaultTexture => Database.GetAsset<Texture>("TextureDefault100").Load<Texture>();
        ...
        public const string GameDeveloperMode = "@Game.DeveloperMode";
        public const string GameIsRunning = "@Game.IsRunning";

        public static bool DeveloperMode => Framework.Settings.developerMode;
        ...
        {
            if (!Framework.TryGetSetting(out T settings)) { Log.Write(SettingsWarning<T>()); return settings; } 
            return settings;
        }
