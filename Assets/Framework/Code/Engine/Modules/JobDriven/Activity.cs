...
namespace Jape
{
	public class Activity : Job, ISelfRestrictor<Activity, object>
    {
        protected override bool ProcessOnStop => false;

        private List<JobQueue.Task> routineTasks = new();

        private JobQueue.Task setupTask;
        private JobQueue.Task successTask;
        private JobQueue.Task cleanupTask;

        private Restrictor<object> restrictor = new();
        ...
        public Activity Restrict(object restrictor)
        {
            this.restrictor.Restrict(restrictor);
            return this;
        }

        public Activity Unrestrict(object restrictor)
        {
