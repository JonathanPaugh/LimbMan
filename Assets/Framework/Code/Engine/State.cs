...
namespace Jape
{
    public class State
    {
        ...
        protected List<Action> trueActions = new List<Action>();
        protected List<Action> falseActions = new List<Action>();
        ...
        public State Restrict(Type restrictor)
        {
            this.restrictor.Restrict(restrictor);
            return this;
        }

        public State Unrestrict(Type restrictor)
        {
