...
namespace Jape
{
    public sealed class SaveManager : Manager<SaveManager> 
    {
        ...
        public static SaveSettings Settings => settings != null ? settings : settings = Framework.Settings<SaveSettings>();

        private static string FilePath => IO.JoinPath(Application.persistentDataPath, $"{FileName}{Settings.Profile}.{Extension}");
