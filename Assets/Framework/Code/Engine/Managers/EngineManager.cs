...
namespace Jape
{
    public sealed class EngineManager : Manager<EngineManager>
    {
        ...
        [NonSerialized] internal List<Mono> runtimeMono = new();
        [NonSerialized] internal List<Element> runtimeElements = new();
        [NonSerialized] internal List<Scriptable> runtimeScriptable = new();

        [NonSerialized] internal List<Shell> shells = new();
        ...
        internal static void ChangeScene(string scenePath, string loadingScreenPath, Action loaded)
        {
            ...
            SceneSettings settings = Framework.Settings<SceneSettings>();
        ...
        private IEnumerable StatRoutine()
        {
            ...
            {
                Vector2 current = new(Time.FrameCount(), Time.TickCount());
