...
namespace Jape
{
	public static partial class Serializer
    {
        ...
        public static SerializerSettings Settings => settings != null ? settings : settings = Framework.Settings<SerializerSettings>();

        internal static void Init()
        {
            settings = Framework.Settings<SerializerSettings>();
        }
