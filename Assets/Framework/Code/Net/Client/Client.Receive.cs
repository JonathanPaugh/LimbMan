...
namespace JapeNet.Client
{
    public partial class Client
    {
        ...
        {
            public static Dictionary<Server.Server.Packets, PacketHandler> packets = new()
            {
            ...
            internal static void Field(Packet packet)
            {
                ...
                NetManager.AccessClientElement(key, e =>
                {
            ...
            internal static void Stream(Packet packet)
            {
                ...
                NetManager.AccessClientElement(key, e =>
                {
                    e.ReceiveStreamData(NetSide.Clientside, packet.ReadObjects());
                });
            }
            ...
            internal static void Sync(Packet packet)
            {
                ...
                NetManager.AccessClientElement(key, e =>
                {
                    e.ReceiveSyncData(NetSide.Clientside, data);
                });
            }
