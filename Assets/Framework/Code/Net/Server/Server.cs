...
namespace JapeNet.Server
{
    public static partial class Server
    {
        ...
        public static readonly NetTable netTable = new();
        public static readonly NetDelegator netDelegator = new();
        private static readonly Dictionary<int, Connection> clients = new();
