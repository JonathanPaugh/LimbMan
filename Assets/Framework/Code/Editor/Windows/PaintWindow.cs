...
namespace JapeEditor
{
    public class PaintWindow : Window
    {
        ...
        private static string RootPath => IO.JoinPath(Framework.Settings<FrameworkSettings>().gamePath, Framework.SystemPath);
        private static string MaterialPath => IO.JoinPath(RootPath, "MaterialPalettes");
        private static string ColorPath => IO.JoinPath(RootPath, "ColorPalettes");
        ...
        {
            if (string.IsNullOrEmpty(currentMaterialPath)) { currentMaterialPath = $"{IO.JoinPath(MaterialPath, "Default")}.asset"; }
            if (string.IsNullOrEmpty(currentColorPath)) { currentColorPath = $"{IO.JoinPath(ColorPath, "Default")}.asset"; }
        ...
        protected override void Draw()
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    string path = $"{IO.JoinPath(MaterialPath, IO.Editor.FileIndexName("MaterialPalette", MaterialPath))}.asset";
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    string path = $"{IO.JoinPath(ColorPath, IO.Editor.FileIndexName("ColorPalette", ColorPath))}.asset";
